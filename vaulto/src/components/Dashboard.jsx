  ...
  const faqs = [
    {
      ...
      answer:
        "We aggregate the best coupons and cashback offers automatically.",
    },
    {
    ...
    <>
      ...
      <div className="app-container dashboard-page">
        ...
        <main className="main-content">
          ...
          <section>
            ...
            {loadingCoupons ? (
              ...
              <p>
                You don't have any coupons yet. Add one to see it here!
              </p>
            ) : (
              ...
              <div className="expiring-scroll no-scroll">
                {expiringCoupons.map((c) => (
                  <div
                    ...
                    onClick={() => {
                      const full = coupons.find(
                        (cp) => cp._id === c.id
                      );
                      if (full) setSelectedCoupon(full);
                    }}
                  >
        ...
        <CouponModal
          ...
          onDelete={
            selectedCoupon
              ? (coupon) => handleDeleteCoupon(coupon._id)
              : undefined
          }
        />
